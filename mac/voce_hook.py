...
def unisci_config(default_path: str, current_path: str) -> None:
    ...
    merged = dict(current)  # conserva anche eventuali chiavi future/personali
    merged.update(defaults)  # il prodotto nuovo porta i suoi default aggiornati
