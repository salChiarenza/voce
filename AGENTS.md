...
1. Logo `LeaderAI.` sulla pill nera in basso al centro: il punto verde `#56C842` cresce con la voce e pulsa mentre trascrive, la firma verde sotto il marchio si disegna da sinistra; con una scritta di stato il marchio si ingrandisce al centro e la scritta resta piccola e grigia; la pill si chiude quando il testo e' incollato.
